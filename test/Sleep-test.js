...
describe('Sleep', function () {
  ...
  it('should calculate a user\'s average number of hours slept per day', function() {
    assert.equal(sleep.getTotalHoursSlept(), 7);
  });

  it('should calculate how many hours they slept for a specific day indetified by date', function() {
    assert.equal(sleep.getHoursSlept(today), 7);
    assert.equal(sleep.getHoursSleept(2020/01/18));
  });

  it('should calculate how many hours sleept each day for a week', function() {
